...
const BecomeManagerModal = ({ closeModal, isOpen }) => {
  ...
  const handleRequest = async () => {
    try {
      await axiosSecure.post('/became-manager')
    ...
    >
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <DialogPanel className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-gray-100 p-6 duration-300 ease-out data-closed:scale-95 data-closed:opacity-0">
          ...
          {/* Icon */}
          <div className="w-14 h-14 rounded-2xl bg-indigo-50 flex items-center justify-center text-2xl mx-auto mb-4">
            🧑‍💼
          </div>
          ...
          <p className="text-sm text-gray-500 text-center mb-6 leading-relaxed">
            As a Club Manager you can create and manage clubs, host events, and engage with your community. Please read the terms before proceeding.
          </p>
